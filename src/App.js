...
function App() {
    ...
    function addToBag(id) {
        setBagItems((prevState) => {
            ...
            const alreadyInTheBag = bagItems.find(
        ...
        <div className="App">
            <BrowserRouter>
                ...
                <Routes>
                    ...
                    <Route
                        path="/shop"
                        element={<Shop cards={cards} addToBag={addToBag} />}
                    />
                    <Route
                        path="/shop/:id"
                        element={
                            <ProductInfo cards={cards} addToBag={addToBag} />
                        }
                    />
                </Routes>
            </BrowserRouter>
